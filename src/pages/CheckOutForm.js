...
import {
  ...
  incrementAsync,
  selectCount,
} from "../features/cart/cartSlicer.js";
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list" className="">
                  {addresses.map((address, index) => (
                    <li
                      key={index}
                      className="flex justify-between gap-x-6 py-5 border-b-2 shadow-sm"
                    >
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto max-w-7xl px-0 sm:px-6 lg:px-0 ">
            <div className="border-t border-gray-200 px-0 py-6 sm:px-0">
              {" "}
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 py-5">
                Cart
              </h1>
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <div className="text-gray-500">
                            <label
                              htmlFor="password"
                              className="inline mr-3 text-sm font-medium text-gray-700"
                            >
                              Qty
                            </label>
