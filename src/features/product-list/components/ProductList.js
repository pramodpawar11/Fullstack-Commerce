...
import { fetchAllProductsAsync, selectAllProducts } from "../productSlice.js";
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="/product-detail">
                              <div
                                key={product.id}
                                className="group relative shadow-md rounded-md p-3"
                              >
                                ...
                                <div className="mt-4 flex justify-between">
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                      <span className="flex items-center">
                                        <StarIcon className="w-5 h-5  fill-green-700 inline " />
                                  ...
                                  <div>
                                    <p className="text-sm font-medium text-gray-900 c">
                                      ₹{" "}
                                      {Math.round(
                                        product.price *
